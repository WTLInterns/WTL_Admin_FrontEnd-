        ...
        <div className="card mb-6 bg-white shadow-lg rounded-lg">
          <div className="flex">
            ...
            <div className="w-2/3 p-4">
              <h5 className="text-xl font-semibold">WorldTripLink DashBoard</h5>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <div className="card bg-white shadow-lg rounded-lg mb-6">
              <div className="p-4">
                <h5 className="text-xl font-semibold">Update Routes Rates</h5>
                <p className="text-gray-600 mt-2">Update routes rates of website</p>
                <div className="mt-4">
                  <a
                    href="/updatetripWTL"
            ...
            <div className="card bg-white shadow-lg rounded-lg mb-6">
              <div className="p-4">
                ...
                <p className="text-gray-600 mt-2">Add Filter on City by Km</p>
                <div className="mt-4">
                  <a
            ...
            <div className="card bg-white shadow-lg rounded-lg mb-6">
              <div className="p-4">
                ...
                <p className="text-gray-600 mt-2">Add Offer images on wtl website</p>
                <div className="mt-4">
                  <a
                    href="/wtl-offer-page"
          ...
          <div>
            <div className="card bg-white shadow-lg rounded-lg mb-6">
              <div className="p-4">
                ...
                <p className="text-gray-600 mt-2">Add Rate According to the states and their kilometers</p>
                <div className="mt-4">
                  <a
            ...
            <div className="card bg-white shadow-lg rounded-lg mb-6">
              <div className="p-4">
                <h5 className="text-xl font-semibold">Update Default Rate</h5>
                <p className="text-gray-600 mt-2">update Default Rate of website</p>
                <div className="mt-4">
                  <a
            ...
            <div className="card bg-white shadow-lg rounded-lg mb-6">
              <div className="p-4">
                ...
                <p className="text-gray-600 mt-2">Check the saved user data from the website popup</p>
                <div className="mt-4">
                  <a
